...
const ProgressBar: React.FC = () => {
    ...
    const handlePropsUpdate = (bookingId: string, fromDate: Date, toDate: Date, phoneNumber: string) => {
        ...
        <>
            <div className='progress-container'>
                <div className='progress-content'>
                    <Link to='/home'>
                        <i className="fa fa-arrow-circle-left back-icon" onClick={scrollToTop}>
                        </i>
                    </Link>
                    <ul>
                        <li>
                ...
                {firstStepCompleted ?
                    <Checkout fromDate={fromDate as Date} toDate={toDate as Date} bookingId={bookingId} phoneNumber={phoneNumber}
                        secondStepProp={handleSecondStep} thirdStepProp={handleThirdStep} lastStepProp={handleLastStep} />
                    :
                    <BookingForm firstStepProp={handleFirstStep} onBookingIdUpdate={handlePropsUpdate} vehicleNumber={vehicleNumber} />
                }
